    ...
    return (
            <div className="fixed inset-0 overflow-hidden">
                ...
                <div className="relative z-10 h-full flex items-center justify-center text-white text-center space-y-6 flex-col px-5">
                    <h1 className="text-7xl font-bold font-dancing-script">Find Your Perfect Study Spot </h1>
                    <p className="text-xl font-roboto-flex">Explore inspiring spaces designed to help you stay focused and motivated</p>
                </div>
            </div>
        </div>
    )
